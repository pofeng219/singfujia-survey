...
export const INITIAL_STATE: SurveyData = {
    ...
    factory_elevator: '', factory_elevator_working: true, factory_elevator_capacity: '', factory_elevator_dim: '',
    factory_crane: '', factory_crane_working: true, factory_crane_tonnage: '', factory_crane_quantity: '',
    factory_waste: '', factory_waste_desc: '',
    factory_loading_dock: '', factory_truck_access: '',
...
export const FACTORY_WASTE_OPTS = ["無", "有(已納管)", "有(自有處理設備)", "其他"];
