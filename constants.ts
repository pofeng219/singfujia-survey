...
export const INITIAL_STATE: SurveyData = {
    ...
    q14_roadMaterial: '', q14_roadMaterialOther: '', q14_roadWidth: '', q14_buildingLine: '', q14_buildingLineOther: '', q14_ditch: '', q14_ditchOther: '',
    ...
    land_q2_material: '', land_q2_material_other: '', land_q2_roadWidth: '', land_q2_buildingLine: '', land_q2_buildingLine_other: '', land_q2_ditch: '', land_q2_ditch_other: '',
    ...
    land_q7_build: '', land_q7_build_type: [], land_q7_build_reg_ownership: '', land_q7_build_unreg_ownership: '', land_q7_build_reg_detail: '', land_q7_build_unreg_detail: '', land_q7_build_rel_detail: [], land_q7_build_other: '', land_q7_solar: '',
...
export const LAND_PROPERTY_TYPE_OPTIONS = ["農地", "建地", "工業地", "其他未列項目"];
...
export const FACTORY_FIRE_OPTS = ["消防水塔", "自動灑水設備", "室內消防栓", "火警探測器", "滅火器", "排煙設備", "泡沫滅火設備"];
export const FACTORY_WASTE_OPTS = ["無", "有", "其他未列項目"];
export const FACTORY_DOCK_OPTS = ["無", "有（一般碼頭）", "有（附油壓升降板）"];
...
export const ENV_CATEGORIES: EnvCategory[] = [
    ...
    { title: "基礎與公用事業", items: ["機場", "台電變電用地", "地面高壓電塔／電纜", "垃圾場", "掩埋場", "焚化爐"] },
