...
export const INITIAL_STATE: SurveyData = {
    ...
    water_booster: '', water_booster_desc: '', // New

    q8_stairIssue: '', q8_stairItems: [], q8_stairOther: '', q8_stairDesc: '',
    q9_hasIssue: '', q9_items: [], q9_hasOther: false, q9_otherDesc: '', q9_solar_maintenance: '',
    ...
    q14_roadMaterial: '', q14_roadMaterialOther: '', q14_roadWidth: '', q14_ditch: '', q14_ditchOther: '',
    ...
    land_q2_material: '', land_q2_material_other: '', land_q2_roadWidth: '', land_q2_ditch: '', land_q2_ditch_other: '',
...
export const FACILITY_OPTIONS = ["變電箱/桶", "基地台", "中繼水箱", "太陽能光電發電設備"];
export const ACCESS_SUB_OPTIONS = ["出租中", "屋主自住", "空屋須請屋主開門", "尚未搬空", "其他"];
export const ACCESS_SUB_OPTIONS_FACTORY = ["出租中", "屋主自用", "空屋須請屋主開門", "尚未搬空", "其他"];
...
export const PROPERTY_TYPE_OPTIONS = ["透天獨棟廠房", "立體化廠辦大樓", "標準廠房(工業園區內)", "倉儲物流廠房", "其他"];
export const HOUSE_PROPERTY_TYPE_OPTIONS = ["透天別墅", "透天店面", "大樓華廈", "公寓"];

// Factory Specific Option Lists
export const FACTORY_FLOOR_OPTS = ["一般水泥", "環氧樹脂(Epoxy)", "硬化地坪", "磨石子", "其他"];
export const FACTORY_FIRE_OPTS = ["自動灑水設備", "室內消防栓", "火警探測器", "滅火器", "排煙設備", "泡沫滅火設備", "其他"];
export const FACTORY_WASTE_OPTS = ["無", "有(已納管)", "工業區統一汙水處理", "有(自有處理設備)", "其他"];
